...
public class Mapping {
    ...
    public static void main(String... args) {
        ...
        words.stream().map(word -> word.split("")).map(Arrays::stream).distinct().forEach(s -> System.out.println(s + "--------------"));


        words.stream().map(word -> word.split("")).flatMap(Arrays::stream).distinct().forEach(s -> System.out.println(s + "++++++++++++++"));
